...
var (
	baseInput    = flag.String("i", "", "the input path")
	overlayInput = flag.String("ol", "", "the overlay path")
...
var (
	...
	s                  *overlayStream
	defaultPts         = astiav.NoPtsValue
)

type overlayStream struct {
	filterDesc       *astiav.FormatContext
	fmt_ctx          *astiav.FormatContext
	dec_ctx          *astiav.CodecContext
	buffersink_ctx   *astiav.FilterContext
	buffersrc_ctx    *astiav.FilterContext
	filter_graph     *astiav.FilterGraph
